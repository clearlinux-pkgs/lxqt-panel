...
Source0  : https://github.com/lxqt/lxqt-panel/releases/download/0.17.1/lxqt-panel-0.17.1.tar.xz
Source1  : https://github.com/lxqt/lxqt-panel/releases/download/0.17.1/lxqt-panel-0.17.1.tar.xz.asc
...
%prep
%setup -q -n lxqt-panel-0.17.1
cd %{_builddir}/lxqt-panel-0.17.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618594045
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-panel-0.17.1/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-panel/7fab4cd4eb7f499d60fe183607f046484acd6e2d
pushd clr-build
%make_install
popd
